...
class NHLOddsItem extends Component {
  componentWillMount() {
  ...
  render() {
    return (
      <tr>
        <th scope="col">
            <img className="logo" alt="NHL Logo" src={require('../../../../static/nhlImages/' + this.props.game.AwayTeamName.toLowerCase() + '.png')} /><br />
            <img className="logo" alt="NHL Logo" src={require('../../../../static/nhlImages/' + this.props.game.HomeTeamName.toLowerCase() + '.png')} />
          </th>
